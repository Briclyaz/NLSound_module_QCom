...
AUTO_EN() {
    ...
    AUTO_In=true
	sed -i 's/AUTO=false/AUTO=true/g' $SETTINGS
...
RU_Manual() {
	...
	sleep 1
	  ...
	  ui_print "*                                                *"
	  ui_print "*         Если вы нажмёте *Установить*,          *"
	  ui_print "*          вы отключите этот механизм.           *"
	  ui_print "*                                                *"
	...
	ui_print " "
	  ...
	  ui_print "*                                                *"
	  ui_print "*          Если вы нажмёте *Установить*,         *"
	  ui_print "*          вы увеличите громкости медиа          *"
	  ui_print "*         (проводные наушники, динамики)         *"
	  ui_print "*                                                *"
	  ui_print "**************************************************"
	ui_print "  "
	sleep 1
	...
	ui_print " "
	  ...
	  ui_print "*                                                *"
	  ui_print "*          Если вы нажмёте *Установить*,         *"
	  ui_print "*        вы увеличите громкости микрофонов       *"
	  ui_print "*                                                *"
	  ui_print "**************************************************"
	ui_print " "
	sleep 1
	...
	ui_print " "
	  ...
	  ui_print "*                                                *"
	  ui_print "*         Если вы нажмёте *Установить*,          *"
	  ui_print "*            вы примените изменения.             *"
	  ui_print "*                                                *"
	...
	ui_print " "
	  ...
	  ui_print "*            вы примените изменения.             *"
	  ui_print "*                                                *"
	  ui_print "*  Эта опция изменит путь DIRECT на DIRECT_PCM,  *"
